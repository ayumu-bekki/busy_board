...
class MCP23017 {
 public:
  ...
  class GPIOGroup {
   public:
    ...
    void SetInput(uint8_t data) {
      gpio_[0].is_input_ = (data & 0x01) != 0;
      gpio_[1].is_input_ = (data >> 1 & 0x01) != 0;
      gpio_[2].is_input_ = (data >> 2 & 0x01) != 0;
      gpio_[3].is_input_ = (data >> 3 & 0x01) != 0;
      gpio_[4].is_input_ = (data >> 4 & 0x01) != 0;
      gpio_[5].is_input_ = (data >> 5 & 0x01) != 0;
      gpio_[6].is_input_ = (data >> 6 & 0x01) != 0;
      gpio_[7].is_input_ = (data >> 7 & 0x01) != 0;
    }
 ...
 public:
  ...
  void SetGpio(uint8_t group_id, uint8_t gpio_no, bool is_output,
               bool is_force = false) {
    if (GPIO_GROUP_NUM <= group_id || GPIO_NUM <= gpio_no) {
      return;
    }
  ...
  bool GetGpio(uint8_t group_id, uint8_t gpio_no) {
    uint8_t buffer = 0;
    ...
    gpio_group_[group_id].SetInput(buffer);
